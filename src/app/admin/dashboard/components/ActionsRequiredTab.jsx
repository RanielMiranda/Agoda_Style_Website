...
import { fakeData, tabs } from "./data/data"
          ...
          displayMessages.map((msg) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 px-4 md:border-l md:border-r border-slate-100 min-w-50">
                <div className="h-9 w-9 rounded-full bg-linear-to-tr from-blue-400 to-indigo-500 flex items-center justify-center text-white font-bold text-xs shrink-0 shadow-sm">
